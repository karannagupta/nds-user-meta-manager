...
spl_autoload_register('nds_user_meta_manager_autoloader');
 ...
 *
 * The argument should be in the form: Nds_User_Meta_Manager\Namespace. The
...
function nds_user_meta_manager_autoloader( $class_name ) {

    // If the specified $class_name does not include our namespace, duck out.
    if ( false === strpos( $class_name, 'Nds_User_Meta_Manager' ) ) {
        return;
    }
